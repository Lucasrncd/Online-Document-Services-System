...
<body>
    ...
    <header class="dashboard-header">
        <div class="header-container">
            ...
            <nav class="nav-links">
                ...
                <a href="ad_paid.php" class="nav-link active">Paid</a>
    ...
    <main class="main-content">
        <h1 class="main-heading">Paid Requests</h1>
    ...
    <script>
        ...
        function fetchDataAndRenderTable(searchTerm = '') {
            ...
            let url = 'admin_paid_requests.php'; 
                ...
                .then(data => {
                    if (data.status === "success" && data.data && data.data.length > 0) {
                        ...
                        data.data.forEach(request => {
                            ...
                            const isNotProcessed = (dbProgress === 'Not Processed');
